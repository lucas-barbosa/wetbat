...
export const Menu = ({ isMenuOpened, onCloseMenuClick }: MenuProps) => {
  ...
  return (
    <aside className={`fixed z-[1001] h-full overflow-auto bg-[#e6e6e6] transition-transform max-md:w-1/2 max-sm:w-full md:translate-x-0 ${isMenuOpened ? openedMenuClasses : closedMenuClasses}`}>
