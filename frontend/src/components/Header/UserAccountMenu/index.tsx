      ...
      {isOpened && (
        <div className="absolute right-0 top-full z-10 w-full overflow-hidden rounded bg-white text-base text-primary-500 shadow sm:top-[calc(100%+1rem)] sm:w-48">
          ...
          <ul className="z-10 mt-2 divide-y divide-gray-100 border-t border-gray-100 bg-white py-2 font-medium">
            <li><a className="block w-full px-3 py-2 text-left transition-colors hover:bg-blue-100" href="/my-account">My Account</a></li>
            <li><button className="block w-full px-3 py-2 text-left transition-colors hover:bg-blue-100" type="button">Logout</button></li>
          </ul>
        </div>
      )}
    </div>
